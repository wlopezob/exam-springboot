...
import com.wlopezo.api_data_v1.exception.DataApiException;
...
public class UserController {
    ...
    @PostMapping
    public Mono<ResponseEntity<UserDataResponse>> save(@RequestBody @Valid UserDataRequest userRequest) {
